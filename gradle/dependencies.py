...
def execute_task_dependencies():
    task_name = ':app:dependencies'
    command = ['./gradlew', task_name, '--configuration', 'releaseRuntimeClasspath']
    print(' '.join(command))
...
if __name__ == "__main__":
    ...
    task_name, task_result = execute_task_dependencies()
    # 第二步：保存任务结果到文件
